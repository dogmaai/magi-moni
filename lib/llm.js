...
const SYSTEM_PROMPT_CORE =
  ...
  '\n\nTIALA操作ツール（Mac mini リモート管理、central-dogma/OpenClaw経由）:' +
  ...
  '\ntiala_services と tiala_system は確認不要で即時実行可能。' +
  '\ntiala_restart と tiala_exec は confirmed=true が必要（初回は確認なしでポリシーチェック→ユーザー確認→再実行）。';
